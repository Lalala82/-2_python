...
# Создать большую переменную result_subtr в которой вычитаете по значению переменную из меньшей по значению
...
result_multi  =  элемент_1  *  элемент_2
...
print ( "rresult_exp =" , результат_exp )

# Создать переменную result_m_exp в которой вы item_1 возводите в степень item_2 используя библиотеку math.
импортная  математика
result_m_exp  =  математика . pow ( элемент_1 , элемент_2 )
print ( "result_m_exp =" , result_m_exp )

#. Создать переменную result_s_root, в которой вы найдёте квадратный корень любой из альтернативных позиций
result_s_root  =  Item_1  **  0,5
print ( "корень_результатов" , корень_результатов )

#. Создать переменную result_m_s_root в которой вы найдёте квадратный корень любой из альтернативных элементов используя библиотеку math
result_m_s_root  =  математика . sqrt ( элемент_1 )
print ( "result_m_s_root =" , result_m_s_root )

# Создать переменную result_mp_s_root в которой вы найдёте квадратный корень любой из альтернативных элементов библиотеки, используя метод pow
result_mp_s_root  =  математика . pow ( элемент_1 ; 0,5 )
...
result_division  =  элемент_1  /  элемент_2
...
result_m_floor  =  математика . этаж ( result_division )
...
result_m_ceil  =  математика . ceil ( result_division )
...
result_int  =  int ( раунд ( result_division ))
...
result_division_loss  =  элемент_1  %  элемент_2
